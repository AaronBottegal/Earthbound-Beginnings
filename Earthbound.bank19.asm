LOOPY_IDFK: ; 13:0000, 0x026000
    LDA #$05
    STA SOUND_EXTRA_UNK ; Clear ??
RTN_0x2: ; 13:0005, 0x026005
...
VAL_LT_0x4: ; 13:0023, 0x026023
    ...
    JSR CREATE_PTR_IN_MISC_USE_UNK ; Do ptr.
    TXA ; X to A.
    PHA ; Save it.
...
SUB_PAGE_AND_FILE_MOVE_UNK: ; 13:008F, 0x02608F
    ...
    TXA
    PHA
    JSR R6_BANK_AND_SETUP_PTR_9800_UNK ; Do.
    LDY #$00 ; Stream reset.
...
ALT_RTN_UNK: ; 13:0909, 0x026909
    ...
    LDA R_**:$0028
    JSR CREATE_PTR_IN_MISC_USE_UNK
    LDA MISC_USE_A
    STA GFX_BANKS[4]
    LDA MISC_USE_B
    STA GFX_BANKS+1
...
L_13:10A3: ; 13:10A3, 0x0270A3
    JSR R6_BANK_AND_SETUP_PTR_9800_UNK
    LDY #$02
    LDA [MISC_USE_A],Y
    AND #$80
    RTS
...
L_13:15C4: ; 13:15C4, 0x0275C4
    LDA R_**:$0028
    JMP CREATE_PTR_IN_MISC_USE_UNK
    JSR $B5C2
    SEC
    LDY #$16
    LDA [MISC_USE_A],Y
...
PTR_MOVE_TO_UNK_ARR_WRAM: ; 13:1B8C, 0x027B8C
    JSR R6_BANK_AND_SETUP_PTR_9800_UNK ; Get ptr.
    LDY #$00 ; Stream index.
    LDA [MISC_USE_A],Y ; Load from stream.
...
PTR_AND_BANK_R6_UNK: ; 13:1BC3, 0x027BC3
    JSR R6_BANK_AND_SETUP_PTR_9800_UNK ; Do ptr.
    LDY #$06 ; Stream index.
...
R6_AND_FILE_MANIP_UNK: ; 13:1BD4, 0x027BD4
    JSR R6_BANK_AND_SETUP_PTR_9800_UNK ; Do ptrs.
    LDY #$02 ; R6 index.
    JSR MISC_FILE_MANIP_UNK ; Do ??
    JMP EXIT_HANDLED? ; Goto.
R6_BANK_AND_SETUP_PTR_9800_UNK: ; 13:1BDF, 0x027BDF
    JSR SUB_PTR_AND_R6_SWAP
    CLC ; Prep add.
    ...
    STA MISC_USE_B
    RTS ; Leave.
SUB_PTR_AND_R6_SWAP: ; 13:1BF0, 0x027BF0
    LDA PTR_CREATE_SEED? ; Move.
    STA MISC_USE_A
    LDA #$00 ; Seed clear.
    ASL MISC_USE_A ; << 1
    ROL A ; Into A.
    ...
    ASL MISC_USE_A ; 3x
    ROL A
    STA MISC_USE_B ; Store to result.
