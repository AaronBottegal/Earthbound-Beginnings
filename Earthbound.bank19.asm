...
VAL_LT_0xF8: ; 13:000C, 0x02600C
    LDA #$A5 ; Val ??
    LSR ENGINE_PALETTE_FPTR/BITS/GEN_USE[2] ; >> 1
...
Y_POSITIVE: ; 13:002F, 0x02602F
    ...
    STA **:$0600,Y ; Store to page at index.
    DEY ; Y--
...
SUB_PAGE_AND_FILE_MOVE_UNK: ; 13:008F, 0x02608F
    ...
    JSR SUB_FUCK_IDK ; Do.
    LDY #$00 ; Stream reset.
    LDA [ENGINE_PALETTE_FPTR/BITS/GEN_USE[2]],Y ; Load from file.
...
FILE_PTR_L: ; 13:0A88, 0x026A88
    ...
    .db 1B
    .db 00
LOOP_MAIN: ; 13:0B0F, 0x026B0F
    JSR STREAM_MOVE_AND_STREAM_BANKED_FOR
    LDY #$14 ; Stream index.
    LDA [ENGINE_FPTR_30[2]],Y ; Load ??
    AND #$0F ; Keep lower.
    TAY ; To Y index.
LOOP_FILE_UNK: ; 13:0B19, 0x026B19
    LDA [ENGINE_FPTR_32[2]],Y ; Load from ptr.
    BEQ PTR_EQ_0x00 ; == 0, goto.
    JSR ROUTINE_LAUNCH_TEXT? ; Do launch.
    JMP LOOP_FILE_UNK ; Loop stream.
PTR_EQ_0x00: ; 13:0B23, 0x026B23
    LDA R_**:$0021 ; Load ??
    BEQ WAIT_PRESSES_UNK ; == 0, goto.
    JSR LIB_RTN_PTR_CREATION/SHIFT+CLEAR_UNK_MOVE_PTR_DOWN_UNK ; Do.
    LDA #$40
    STA **:$0034 ; Set ??
    BNE LOOP_MAIN ; Always taken, loop.
WAIT_PRESSES_UNK: ; 13:0B30, 0x026B30
    LDA R_**:$002C ; Load ??
...
EXIT_RET_CS: ; 13:0B3C, 0x026B3C
    SEC ; Ret CS.
    RTS ; Leave.
STREAM_MOVE_AND_STREAM_BANKED_FOR: ; 13:0B3E, 0x026B3E
    JSR STREAM_PTR_0x30->0x32_HELPER ; Do.
L_13:0B41: ; 13:0B41, 0x026B41
    LDY #$01 ; Stream index.
    LDA [ENGINE_FPTR_30[2]],Y ; Load data.
    JMP VAL_BANKED_R6_AND_BASED ; Goto.
STREAM_MOVE_BANK_STREAM_READ_UNK: ; 13:0B48, 0x026B48
    JSR STREAM_MOVE_AND_STREAM_BANKED_FOR ; Do.
    LDY #$1C ; Stream index.
    LDA [ENGINE_FPTR_30[2]],Y ; Load from stream.
    TAY ; To Y index.
    JMP LOOP_FILE_UNK ; Goto.
    JSR LIB_RTN_PTR_CREATION/SHIFT+CLEAR_UNK_MOVE_PTR_DOWN_UNK ; Do ??
    JSR STREAM_MOVE_AND_STREAM_BANKED_FOR ; Do ??
    LDY R_**:$0035
    JMP LOOP_FILE_UNK
ROUTINE_LAUNCH_TEXT?: ; 13:0B5E, 0x026B5E
    ASL A ; << 1, *2.
    TAX ; To X index.
...
L_13:1063: ; 13:1063, 0x027063
    JSR L_13:109A
    LDY #$50
L_13:1068: ; 13:1068, 0x027068
    STY SAVE_GAME_MOD_PAGE_PTR[2]
    LDY #$00
L_13:106C: ; 13:106C, 0x02706C
