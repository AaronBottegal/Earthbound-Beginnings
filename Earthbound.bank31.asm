...
RTS: ; 1F:02A1, 0x03E2A1
    ...
    TAX
    RTS
    JSR STREAM_PTR_0x30->0x32_HELPER
    LDY #$14
    LDA [ENGINE_FPTR_30[2]],Y
    AND #$0F
    TAY
...
L_1F:0646: ; 1F:0646, 0x03E646
    ...
    RTS
STREAM_PTR_0x30->0x32_HELPER: ; 1F:0655, 0x03E655
    LDY #$02 ; Stream index.
...
VAL_EQ_0x50: ; 1F:121C, 0x03F21C
    ...
    JSR LIB_UNK_CA3
    RTS
LIB_MAPPER_BANKED_UNK: ; 1F:1239, 0x03F239
    PHA
    TXA
    PHA
    LDA #$16
...
SETTLE_SPRITES_OFFSCREEN/CLEAR_RAM: ; 1F:1D5E, 0x03FD5E
    ...
    SEC ; Shift in 0x1
    ROR NMI_FLAG_OBJECT_PROCESSING? ; Rotate, smol set.
