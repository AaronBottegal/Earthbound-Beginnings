...
ARR_LT_0x8: ; 17:0110, 0x02E110
    ...
    LDA #$80
    STA NMI_FLAG_EXECUTE_UPDATE_BUF ; Set flag to do.
    LDA #$23
...
SUB_IDFK: ; 17:028A, 0x02E28A
    ...
    AND #$03
    LSR A
    ROR LOCAL_VARS_ARR?[8]
    LSR A
    ROR LOCAL_VARS_ARR?[8]
    SEC
    LDA LOCAL_VARS_ARR?[8]
    SBC #$19
    STA LOCAL_VARS_ARR?[8]
    LDA SAVE_GAME_MOD_PAGE_PTR[2]
    ASL A
    ...
    LDA #$80
    STA NMI_FLAG_EXECUTE_UPDATE_BUF
...
SUB_UNK: ; 17:050A, 0x02E50A
    ...
    STA STREAM_PTRS_ARR_UNK+5,Y
    JSR $AC23
    JSR RESTORE_FPTR_AND_CALL_FROM_FILE
    .db A3
    .db A7
    .db 40
    .db A7
    ...
    LDX #$7B
    LDY #$9F
    STX FPTR_MENU_SUBMENUUUUUUUUUUUUU[2]
    STY FPTR_MENU_SUBMENUUUUUUUUUUUUU+1
    LDX #$6B
    LDY #$9F
...
L_17:0CD6: ; 17:0CD6, 0x02ECD6
    ...
    ???
    ???
    LDA [NMI_FLAG_EXECUTE_HOLD_MULTIPART/BOTTOM?],Y
    LDA [R_**:$0002],Y
    ???
    ORA PPU_STATUS,X
    ???
