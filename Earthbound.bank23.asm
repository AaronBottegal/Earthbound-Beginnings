...
ARR_LT_0x8: ; 17:0110, 0x02E110
    ...
    STA SOUND_MAIN_SONG_ID ; Clear flag ??
    LDX #$80 ; Seed ??
...
X_NONZERO: ; 17:023E, 0x02E23E
    ...
    LDA #$80 ; Val adding.
    ADC MISC_USE_D/DECIMAL_POS? ; += val.
...
L_17:04BB: ; 17:04BB, 0x02E4BB
    ...
    RTS
    LDX #$00
    STX MISC_USE_D/DECIMAL_POS?
    LDX #$03
    ASL A
    ROL MISC_USE_D/DECIMAL_POS?
    DEX
    BNE 17:0AAA
    CLC
    ADC #$00
