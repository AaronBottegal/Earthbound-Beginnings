    ...
    LOW(1F:06E9)
    HIGH(1F:06E9)
    LOW(NMI_FLAG_EXECUTE_UPDATE_BUF)
    HIGH(NMI_FLAG_EXECUTE_UPDATE_BUF)
    LOW(1F:15D3)
    HIGH(1F:15D3)
    LOW(1F:16F2)
    HIGH(1F:16F2)
    ...
    LOW(1F:09E8)
    HIGH(1F:09E8)
    LOW(MAPPER_BANK_VALS)
    HIGH(MAPPER_BANK_VALS)
    LOW(1F:03CF)
    HIGH(1F:03CF)
    LOW(1F:12E1)
    HIGH(1F:12E1)
    ...
    LOW(1F:01D0)
    HIGH(1F:01D0)
    LOW(ROM_DATA_ARR_FUCK)
    HIGH(ROM_DATA_ARR_FUCK)
    LOW(1F:04FA)
    HIGH(1F:04FA)
    LOW(1E:0100)
    HIGH(1E:0100)
    ...
    LOW(1F:0FC3)
    HIGH(1F:0FC3)
    LOW(MAP_RTN_O_SET_SWITCH_EXIT_JMP)
    HIGH(MAP_RTN_O_SET_SWITCH_EXIT_JMP)
    LOW(1F:12E1)
    HIGH(1F:12E1)
    LOW(1E:0300)
    HIGH(1E:0300)
