...
LATCH_FLAG_RTN: ; 1E:02B3, 0x03C2B3
    JSR LIB_GFX_HELPER_R6_TO_0x00 ; Do.
    JSR ENGINE_SETTLE_ALL_UPDATES? ; Settle.
    LDX #$00
...
LIB_GFX_HELPER_R6_TO_0x00: ; 1E:0322, 0x03C322
    LDA #$00 ; Bank.
    LDX #$06 ; R6.
...
VAL_NONZERO: ; 1E:0B91, 0x03CB91
    ...
    BCC ANY_SET_RTN ; Ret CC, goto.
VAL_EQ_0x00: ; 1E:0BAD, 0x03CBAD
    ...
    ORA UNK_NONZERO_SKIP ; Set with others.
    ORA R_**:$0021
    ORA FIRST_LAUNCHER_HOLD_FLAG?
    BNE ANY_SET_RTN ; != 0, goto.
    TYA ; Buttons to A.
    AND #$F0 ; Test A/B/SEL/START
    BMI A_PRESSED ; A pressed, goto.
    BNE B/SEL/START_PRESSED ; != 0, goto.
    JSR MAIN_RTN_MENU?_UNK ; Do ??
    JMP NOT_PRESSED_RTN ; Goto.
B/SEL/START_PRESSED: ; 1E:0BCD, 0x03CBCD
...
ANY_SET_RTN: ; 1E:0BEB, 0x03CBEB
    ...
    BNE RTN_FOR_CS ; Nonzero, goto.
VAL_EQ_0x00: ; 1E:0C11, 0x03CC11
    JMP MAIN_LOOP_REENTRY_SECOND_LARGEST ; Do ??
RTN_FOR_CS: ; 1E:0C14, 0x03CC14
    JMP MAIN_LOOP_REENTRY_LARGEST ; Do ??
VAL_EQ_0x00: ; 1E:0C17, 0x03CC17
    JMP MAIN_LOOP_REENTRY_THIRD_LARGEST ; Do ??
VAL_EQ_0xA2: ; 1E:0C1A, 0x03CC1A
    JSR ENGINE_HELPER_R6_0x14 ; Set R6.
    JSR 14:1779 ; Do ??
    JSR LIB_UNK ; Do ??
    BCS RTN_FOR_CS
...
BANK_R6/INIT_PTR/SET_UNK: ; 1E:1E29, 0x03DE29
    LDA SCRIPT_R6_ROUTINE_SELECT ; Load ??
    JSR VAL_BANKED_R6_AND_BASED ; Bank R6.
    ASL A ; Val based.
    TAX ; To index.
...
VAL_BANKED_R6_AND_BASED: ; 1E:1E6C, 0x03DE6C
    CMP #$2B ; If _ #$2B
    BCC LT_0x2B ; <, goto.
