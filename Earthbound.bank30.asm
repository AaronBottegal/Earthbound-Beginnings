...
TEST_SAVE_INDEX_X_CC_0x1-0x5: ; 1E:19F1, 0x03D9F1
    SEC ; Prep ret CS.
    LDA CURRENT_SAVE_MANIPULATION_PAGE+8,X ; Load indexed from manip page.
    BEQ RTS ; == 0, goto. Ret CS.
...
RTN_RET_CS: ; 1E:1ADD, 0x03DADD
    ...
    LDA #$FF
    STA PAIR_UNK_2A[2] ; Set ??
    LDA PAIR_UNK_2A+1 ; Load ??
    ORA #$1F ; Set ??
CC_LOOP: ; 1E:1B0A, 0x03DB0A
    ASL PAIR_UNK_2A[2] ; << var.
    ASL A ; << 1.
    BCC CC_LOOP ; CC, do more.
    JSR RANDOMIZE_GROUP_0x26 ; Do adds.
    AND PAIR_UNK_2A[2] ; Remove ??
